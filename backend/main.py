...
app.config['JWT_SECRET_KEY'] = os.getenv('JWT_SECRET_KEY', 'default-secret-key-for-dev')
...
def add_comment(todo_id):
    ...
    todo_item = TodoItem.query.filter_by(id=todo_id, user_id=user.id).first_or_404()
